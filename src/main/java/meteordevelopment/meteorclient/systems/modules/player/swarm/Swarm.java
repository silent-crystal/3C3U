...
package meteordevelopment.meteorclient.systems.modules.player.swarm;
...
public class Swarm extends Module {
    ...
    public Swarm() {
        super(Categories.Player, "swarm", "Allows you to control multiple instances of Meteor from one central host.");
    }
